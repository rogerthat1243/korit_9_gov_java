...
public class BoardMain {
    public static void main(String[] args) {
        ...
        l1.add(new HashMap<String, String>());
        ((HashMap<String, String>)l1.get(0)).put("writer", "김준이"); // 다운캐스팅 예시
        ...
        ((HashMap<String, Object>) boardMap2.get("writer")).put("name", "김준삼");
        ((HashMap<String, Object>) boardMap2.get("writer")).put("age", 32);
        ...
        ((ArrayList<HashMap<String, String>>) boardMap2.get("comments")).add(new HashMap<String, String>());
        ((ArrayList<HashMap<String, String>>) boardMap2.get("comments")).get(0).put("writer", "김준사");
        ((ArrayList<HashMap<String, String>>) boardMap2.get("comments")).get(0).put("content", "댓글 내용3");
        ((ArrayList<HashMap<String, String>>) boardMap2.get("comments")).get(1).put("writer", "김준오");
        ((ArrayList<HashMap<String, String>>) boardMap2.get("comments")).get(1).put("content", "댓글 내용4");
